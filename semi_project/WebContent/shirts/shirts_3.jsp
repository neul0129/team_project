					...
					<div class="product-detaildesign">
						...
						<tr class=" xans-record-">
							<td style="line-height: 18px !important;"><span
								...
								<br> 원산지 : 중국 <br> 품번 : MHP42M0002WT <br> 혼용율 : 면
									100%<br> 세탁방법 <br> 30℃에서 중성세제로 약하게 세탁하십시오. <br>
									염소, 산소 표백은 피해주십시오. <br> 사이즈 가이드 <br>1: 가슴둘레 105cm,
									총길이 62.5cm, 소매길이 72cm  <br> 2 : 가슴둘레 102cm,
									총길이 66.5cm, 소매길이 76cm <br> 사이즈는 실제 크기와 다를 수 있습니다.<br>
							</span></td>
						</tr>
						<tr class=" xans-record-">

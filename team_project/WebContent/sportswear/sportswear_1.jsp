		...
		<div class="detailArea ">
			...
			<div class="infoArea">
				<div class="product-detaildesign">
					...
					<tr class=" xans-record-">
						<td style="line-height: 18px !important;"><div
								...
								보트넥의 와이드 스트라이프 티셔츠입니다. <br> 여성용 상품입니다. <br> 원산지 : 일본 <br>
								품번 : MHP42T0002IV <br> 혼용율 : 면 100% <br> 세탁방법 <br>
								30℃에서 중성세제로 약하게 세탁하십시오.<br> 염소, 산소 표백은 피해주십시오. <br>
								사이즈 가이드 <br> 2 : 가슴둘레 98cm, 총 길이 58.5cm, 소매길이 55cm <br>
				...
				<div class="displaynone2">
					<label>2:</label>
					<p>MHL. WIDE STRIPE DRY JERSEY IVORY</p>
					<span>268,000</span>
				</div>

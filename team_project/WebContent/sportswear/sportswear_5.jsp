		...
		<div class="detailArea ">
			...
			<div class="infoArea">
					...
					<tr class=" xans-record-">
						<td style="line-height: 18px !important;"><div
								...
								<span style="font-size: 11px; color: #6a696c;">코튼 소재의
									티셔츠입니다. <br> 여성용 제품입니다. <br> <br> 원산지 : 일본 <br>
									품번 : MHP42T0001NA <br> 혼용율 : 겉감1 면 100%, 겉감2 면 95% 폴리우레탄
									5%<br> 세탁방법 <br> 30℃에서 중성세제로 약하게 세탁하십시오.<br> 염소,
									산소 표백은 피해주십시오. <br> 이염에 주의하십시오. <br> 사이즈 가이드 <br>
									1 : 가슴둘레 112cm, 총길이 61cm, 소매길이 77cm <br> 2 : 가슴둘레 119cm,
									총길이 62cm, 소매길이 78cm<br> 사이즈는 실제 크기와 다를 수 있습니다.<br>
							</div></td>
					</tr>
					<tr class=" xans-record-">
						<td style="line-height: 18px !important;"><div
				...
				<div class="displaynone1">
					<label>1:</label>
					<p>MHL. FADED COTTON TWILL IVORY</p>
					<span>468,000</span>
				</div>
